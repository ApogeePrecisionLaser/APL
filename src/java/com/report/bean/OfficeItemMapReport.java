 ...
 * @author Komal
 */
public class OfficeItemMapReport {
   ...
   private int inventory_id;
    ...
    /**
     * @return the searchOrgOffice
     */
    public String getSearchOrgOffice() {
        return searchOrgOffice;
    }

    /**
     * @param searchOrgOffice the searchOrgOffice to set
     */
