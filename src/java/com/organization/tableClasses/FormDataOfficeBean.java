 ...
 * @author Dell
 */
public class FormDataOfficeBean {
    ...
    public String getOfflandline() {
        return offlandline;
    }

    public void setOfflandline(String offlandline) {
        this.offlandline = offlandline;
    }
