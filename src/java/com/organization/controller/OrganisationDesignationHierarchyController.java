...
import com.organization.model.OrganisationDesignationHierarchyModel;
import com.organization.tableClasses.OrgOfficeHierarchyBean;
import com.organization.tableClasses.Org_Office;
import com.organization.tableClasses.OrganisationDesignationHierarchyBean;
...
public class OrganisationDesignationHierarchyController extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        OrganisationDesignationHierarchyModel organisationModel = new OrganisationDesignationHierarchyModel();
        try {
        ...
        try {
            ...
            try {
                ...
                if (JQstring != null) {
                    ...
                    if (JQstring.equals("getSerialNo")) {
                        list = organisationModel.getSerialNo(q);
                        ...
                        list = organisationModel.getDesignationSearch(q, request.getParameter("action2"));
            ...
            if (task.equals("Delete")) {
                ...
                orgOffice.setSerialnumber(request.getParameter("serialnumber").trim());
                orgOffice.setSuperp(request.getParameter("super").trim());
                if (org_office_id == 0) {
...
//        }
            ...
            List<OrganisationDesignationHierarchyBean> organisationList = organisationModel.showData(lowerLimit, noOfRowsToDisplay, serial_no, designation);
            ...
            if (isOrgBasicStep.equals("Yes")) {
                ...
                request.getRequestDispatcher("orgnisationdesignationhierarchy").forward(request, response);
            } else {
                request.getRequestDispatcher("/orgnisationdesignationhierarchy").forward(request, response);
            }
        } catch (Exception ex) {
