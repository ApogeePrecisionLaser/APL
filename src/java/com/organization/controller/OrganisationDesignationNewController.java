...
import com.healthDepartment.organization.model.OrganisationDesignationModel;
import com.healthDepartment.organization.model.OrganisationDesignationNewModel;
...
public class OrganisationDesignationNewController extends HttpServlet {
  ...
  /*      HttpSession session = request.getSession(false);
        ...
        OrganisationDesignationNewModel organisationModel = new OrganisationDesignationNewModel();
        String active="Y";
            ...
            if (requester != null && requester.equals("PRINT")) {
              ...
              ServletOutputStream servletOutputStream = response.getOutputStream();
               List  listAll=organisationModel.showPDF(organisation,designation,getgeneration,active1,searchhierarchy);
                jrxmlFilePath = ctx.getRealPath("/report/orgdesignation.jrxml");
...
//        }
        ...
        //    if (org_name != null && !org_name.isEmpty()) {
                noOfRowsInTable = organisationModel.getNoOfRows(organisation,designation,getgeneration,active,searchhierarchy);
        //    } else {
        ...
        //    }// get the number of records (rows) in the table.
            ...
            if (isOrgBasicStep.equals("Yes")) {
                ...
                request.getRequestDispatcher("organisationdesignationNew").forward(request, response);
            } else {
                request.getRequestDispatcher("organisationdesignationNew").forward(request, response);
            }
        } catch (Exception ex) {
