        ...
        try {
           ...
           String serial_no = request.getParameter("searchDesignationCode");
            ...
            if (requester != null && requester.equals("PRINT")) {
                  isOrgBasicStep = request.getParameter("isOrgBasicStep");
            serial_no = request.getParameter("searchDesignationCode");
             designation = request.getParameter("searchDesignation");
              after_save_organisation = (request.getParameter("organisation_name"));
                  after_save_office_type = (request.getParameter("office_type"));
                 
                  office_code = (request.getParameter("office_code_search"));
               
                  office_name =  (request.getParameter("office_name_search"));
               ...
               List  listAll=organisationModel.showPDF(organisation_name, office_code,office_name,mobile,searchgeneration,active1,searchhierarchy);
                jrxmlFilePath = ctx.getRealPath("/report/orgoffice.jrxml");
...
//        }
        ...
        //    if (org_name != null && !org_name.isEmpty()) {
                noOfRowsInTable = organisationModel.getNoOfRows(org_name, office_code_search, office_name_search,active);
                 ...
                 noOfRowsInTable = organisationList1.size();
        //    } else {
        ...
        //    }// get the number of records (rows) in the table.
            ...
            List<Org_Office> organisationList = organisationModel.showData(lowerLimit, noOfRowsToDisplay, org_name, office_code_search, office_name_search,mobile,searchgeneration,active,searchhierarchy);
