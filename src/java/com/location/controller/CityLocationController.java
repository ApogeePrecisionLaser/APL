...
import com.location.bean.CityLocationBean;
import com.location.model.CityLocationModel;
...
public class CityLocationController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(cityLocationModel.getConnection());
        ...
        try {
            ...
            if (JQstring != null) {
                ...
                gson.put("list", list);
                out.println(gson);
                DBConnection.closeConncetion(cityLocationModel.getConnection());
                return;
            }
        } catch (Exception e) {
