...
import com.location.model.AreaTypeModel;
import com.location.bean.AreaTypeBean;
...
public class AreaTypeController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(areaTypeModel.getConnection());
        ...
        try {
            ...
            if (JQstring != null) {
                ...
                gson.put("list", list);
                out.println(gson);
                DBConnection.closeConncetion(areaTypeModel.getConnection());
                return;
            }
        } catch (Exception e) {
