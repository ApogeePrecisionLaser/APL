...
import com.location.model.WardModel;
...
public class WardController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(wardTypeModel.getConnection());
        ...
        try {
            ...
            if (JQstring != null) {
                ...
                if (JQstring.equals("getWardName")) {
                    ...
                    list = wardTypeModel.getWardNo(q);
                }

                JSONObject gson = new JSONObject();
                gson.put("list", list);
                out.println(gson);
                DBConnection.closeConncetion(wardTypeModel.getConnection());
                return;
            }
        } catch (Exception e) {
        ...
        if (task.equals("Delete")) {
            ...
            if (ward_id_m == 0) {
                ...
                wardTypeModel.updateRecord(wardTypeBean, ward_id_m);
            }
        }
        ...
        List<WardTypeBean> wardTypeList = wardTypeModel.showData(lowerLimit, noOfRowsToDisplay, searchWardType, searchWardNo);
