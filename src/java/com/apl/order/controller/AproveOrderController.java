...
import com.apl.order.model.AproveOrderModel;
        ...
        try {
            ...
            if (task.equals("Delete")) {
                ...
                for (int i = 0; i < indent_item_id_arr.length; i++) {
                    ...
                    String itemprice=request.getParameter("price" + indent_item_id);
                    String s=model.insertPrice(indent_table_id, indent_item_id, itemprice);
