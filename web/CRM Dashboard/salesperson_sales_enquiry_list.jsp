                ...
                <div class="col-sm-9">
                    <div class="d-flex main_searchWrap">
                        ...
                        <div class="enquirySearchWrap">
                            <form name="my-form" method="post" action="ApproveOrdersController?task=sales_enquiry_list" class="d-flex">
                                <div class="row">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="alert alert-danger alert-dismissible myAlertBox" style="display:none">
                                <button type="button" class="close" data-dismiss="alert">&times;</button>
                                <strong>Success!</strong> Indicates a successful or positive action.
                            </div>
                        </div>
