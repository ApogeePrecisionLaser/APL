                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="beanType" items="${requestScope['list']}" varStatus="loopCounter">
                                                <tr
                                                    ...
                                                    <td><a href="tel:+${beanType.off_mobile_no1}" class="nowrap"><i class="fas fa-mobile-alt fontTwelve"></i> ${beanType.off_mobile_no1}</a></td>
                                                    <td>${beanType.key_person_name}</td>
                                                    <!--<td>${beanType.kp_address_line1}</td>-->
                                                    <td><a href="tel:+${beanType.off_mobile_no1}" class="nowrap"><i class="fas fa-mobile-alt fontTwelve"></i> ${beanType.kp_mobile_no1}</a></td>
