    ...
    <body class="hold-transition sidebar-mini layout-fixed" >
        <div class="wrapper">
            <!--  <div class="preloader flex-column justify-content-center align-items-center">
               <img class="animation__shake" src="dist/img/logo.png" height="60" width="60">
             </div> -->
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav ml-auto mr-3">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <a href="saleEnquiry.php" class="dropdown-item">
                                <i class="fas fa-envelope mr-2"></i> 4 Sales Enquiry
                                <span class="float-right text-muted text-sm">3 mins</span>
                            </a>
                            <div class="dropdown-divider"></div>
                            <a href="complaintEnquiry.php" class="dropdown-item">
                                <i class="fas fa-envelope mr-2"></i> 8 Complaint Enquiry
                ...
                <!--
                                <aside class="main-sidebar sidebar-dark-primary elevation-4" id="asideID">
                                    <a href="CRMDashboardController" class="brand-link text-center" style="margin-top: -6px;">
                                         <img src="dist/img/logo.png" class="brand-image img-circle elevation-3 mr-0 mt-1" style="opacity: .8;"> 
                                        <span class="brand-text font-weight-light1 font-weight-bold">Apogee CRM</span>
                                    </a>
                                    <div class="sidebarNavWrap">
                                        <nav class="mt-2">
                                            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="true">
                                                <li class="nav-item myMainNavItem myMainNavItem1">
                                                ...
                                                <li class="nav-item myMainNavItem">
                                                    <a href="CRMDashboardController" class="nav-link">
                                                    ...
                                                    <ul class="nav nav-treeview">
                                                        <li class="nav-item">
                                                            <a href="DealersOrderController" class="nav-link">
                                                                ...
                                                                <p>Dealer New Order</p>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="DealersInventoryController" class="nav-link">
                                                                <i class="far fa-circle nav-icon"></i>
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="DealersComplaintController" class="nav-link">
                                                                <i class="far fa-circle nav-icon"></i>
                                                                <p>Dealer Complaint</p>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="DealersSalesController" class="nav-link">
                                                                <i class="far fa-circle nav-icon"></i>
                                                                <p>Dealer Sales</p>
                                                            </a>
                                                        </li>
                ...
                <aside class="main-sidebar sidebar-dark-primary elevation-4" id="asideID">
                    <!--                    <a href="index.php" class="brand-link bg-white pl-3" style="margin-top: -6px;">
                                            <img src="CRM Dashboard/assets2/img/product/logo.png" style="width:134px;">
                                             <img src="dist/img/logo.png" class="brand-image img-circle elevation-3 mr-0 mt-1" style="opacity: .8;"> 
                                             <span class="brand-text font-weight-light1 font-weight-bold">Apogee CRM</span> 
                                        </a>-->

                    <a href="index.php" class="brand-link bg-white pl-3" style="margin-top: -6px;">
                        <!-- <img src="dist/img/product/logo.png" style="width:134px;"> -->
