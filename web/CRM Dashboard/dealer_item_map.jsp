                                    ...
                                    <table class="table table-striped1 mainTable" id="mytable" >
                                        ...
                                        <tbody>
                                            ...
                                            <td class="fontFourteen d-flex">
                                                <div>
                                                    <a class="btn far fa-trash-alt actionDelete" title="Delete" href="DealerItemMapController?task=deleteMapping&dealer_item_map_id=${beanType.dealer_item_map_id}"></a>
                                                </div> 
                                            </td>
                                            </tr> 
                                        </c:forEach>
