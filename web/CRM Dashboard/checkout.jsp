                                ...
                                <table class="table table-bordered mb-0 text-white">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="fontFourteen" id="subtotal">${total_amount}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="fontFourteen" style="font-size: 15px;font-weight: 600;">Total Amount</td>
                                            <td class="fontFourteen" style="font-size: 15px;font-weight: 600;" id="total_amount">${total_discount_price}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>               
