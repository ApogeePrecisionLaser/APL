            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="#" target="_blank" method="post">
                        ...
                        <div class="input-group mb-3">
                            <input type="email" class="form-control rounded-0 fontFourteen" placeholder="Email">
                            <div class="input-group-append">
                                <div class="input-group-text rounded-0">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" class="form-control rounded-0 fontFourteen" placeholder="Password" required="">
                            <div class="input-group-append">
                                <div class="input-group-text rounded-0">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button type="submit" class="btn myThemeBtn btn-block">Sign In</button>
                            </div>
                        </div>
                    </form>
