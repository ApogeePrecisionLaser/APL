    ...
    $(function () {
        ...
        $("#zone_name").autocomplete({
            ...
            select: function (events, ui) {
                console.log(ui);
                $('#zone_name').val(ui.item.label); // display the selected text
                return false;
            }
        });
        ...
        $("#ward_name").autocomplete({
            ...
            select: function (events, ui) {
                console.log(ui);
                $('#ward_name').val(ui.item.label); // display the selected text
                return false;
            }
        });
