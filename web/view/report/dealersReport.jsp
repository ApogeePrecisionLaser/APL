...
//                var searchDesignation = document.getElementById("searchDesignation").value;
                ...
                $.ajax({
                    ...
                    data: {action1: "getPerson",
                        search_org_name: search_org_name, search_org_office_name: search_org_office_name, searchPerson: searchPerson},
                    success: function (data) {
                        console.log(data);
                        response(data.list);
                    }, error: function (error) {
...
//        var searchDesignation = document.getElementById("searchDesignation").value;
        ...
        queryString = "task=View Report&search_org_name=" + search_org_name + "&search_org_office_name=" + search_org_office_name;
        //  queryString = "task=viewPdf";
        var url = "DealersReportController?" + queryString;
...
<section class="marginTop30">
    <div class="container organizationBox">
        ...
        <form name="form1" method="POST" action="DealersReportController" onsubmit="return verifySearch();" >
            <div class="row mt-3">
                <div class="col-md-4">
