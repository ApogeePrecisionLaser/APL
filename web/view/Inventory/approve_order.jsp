...
<script>
    ...
    function openPopUpForItems(indent_table_id, indent_status) {
        var url = "ApproveOrderController?task=GetIndentItems&indent_table_id=" + indent_table_id + "&indent_status=" + indent_status;
    ...
    function searchIndentStatusWise(status) {
        var url = "ApproveOrderController?action1=searchIndentStatusWise&status=" + status;
...
<section>
    <div class="container organizationBox">
        <div class="headBox" style="background-color: #6D9FBD">
         ...
         <form name="form3" method="POST" action="ApproveOrderController" >
