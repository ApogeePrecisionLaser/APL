...
//        $('#item_name').val($("#" + count + '4').html());
        $('#item_code').val($("#" + count + '6').html() + " - " + $("#" + count + '7').html());
        $('#model_name').val($("#" + count + '8').html());
        $('#key_person').val($("#" + count + '9').html());
        $('#quantity').val($("#" + count + '10').html());
        $('#min_quantity').val($("#" + count + '11').html());
        $('#daily_req').val($("#" + count + '12').html());
        $('#opening_balance').val($("#" + count + '13').html());
        $('#date_time').val($("#" + count + '14').html());
        $('#description').val($("#" + count + '15').html());
