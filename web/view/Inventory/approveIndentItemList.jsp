        ...
        <div class="row mt-3 myTable">
            <div class="col-md-12">
                <div class="table-responsive verticleScroll">
                    <form action="ApproveIndentController" method="POST">
                                    ...
                                    <tr>
                                        ...
                                        <c:choose>
                                            <c:when test="${(beanType.approved_qty == 0)  && (beanType.status == 'Pending')}">
                                                ...
                                                <td id="${loopCounter.count }"><input type="text" id="status${beanType.indent_item_id}" class="myAutocompleteClass" name="item_status${beanType.indent_item_id}" value="">
                                                </td>
                                            </c:when>
