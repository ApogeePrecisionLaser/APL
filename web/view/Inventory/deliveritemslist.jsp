...
function deliveritem(){
    var indent_table_id=document.getElementById("indent_table_id").value;
    alert(indent_table_id);
     var url = "CheckOrderInventoryController?task=GenerateDeliveryChallan&final_indent_table_id=" + indent_table_id ;
        popupwin = openPopUp(url, "", 600, 1030);
        //CheckOrderInventoryController?task=GenerateDeliveryChallan&final_indent_table_id=68
    //localhost:8080/APL/CheckOrderInventoryController?task=GenerateDeliveryChallan&final_indent_table_id=68
}
</script>
            ...
            <div class="col-md-12">
                <div class="table-responsive verticleScroll">
                    <form action="CheckInventoryController" method="POST">
                        ...
                        <input type="button"  style="display: none" class="btn btn-danger" value="Deliver item" id="deliver" name="task" onclick="deliveritem()">
