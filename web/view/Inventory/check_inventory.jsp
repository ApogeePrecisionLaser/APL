...
<script>
    ...
    $(document).ready(function () {
        ...
        if (final_task == "Generate Delivery Challan") {
            if ((final_indent_table_id != "") && (delivery_indent_table_id == "") && (delivery_indent_status != "Delivered")) {
                var url = "CheckInventoryController?task=GenerateDeliveryChallan&final_indent_table_id=" + final_indent_table_id;
    ...
    function openPopUpForItems(indent_table_id, status) {
        var url = "CheckInventoryController?task=GetIndentItems&indent_table_id=" + indent_table_id + "&indent_status=" + status;
        popupwin = openPopUp(url, "", 600, 1030);
    ...
    function searchIndentStatusWise(status) {
        var url = "CheckInventoryController?action1=searchIndentStatusWise&status=" + status;
...
<section>
    <div class="container organizationBox">
        ...
        <form name="form3" method="POST" action="CheckInventoryController" >
