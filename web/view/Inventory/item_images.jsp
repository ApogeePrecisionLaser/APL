...
<html>
    ...
    <body>
        ...
        <script>
            ...
            function deleteImages(id,item_names_id) {
                var queryString = "task1=deleteImage&item_image_details_id=" + id+"&item_names_id="+item_names_id;
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="beanType" items="${requestScope['list']}"
                                        ...
                                        <tr>
                                            ...
                                            <!--<td id="${loopCounter.count }3">${beanType.destination_path}</td>-->                                                
                                            <td id="${loopCounter.count }3" >
                                                ...
                                                <input type="button" class="btn btn-danger" id="${loopCounter.count}" name="delete"
                                                       value="Delete" onclick="deleteImages(${beanType.item_image_details_id},${beanType.item_names_id})">
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
