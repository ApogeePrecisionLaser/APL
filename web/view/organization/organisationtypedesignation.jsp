...
<html>
    <head>
        ...
        <title> Organization Type Designation  </title>
...
<script  type="text/javascript" src="time/bootstrap-datetimepicker.min.js"></script>
        ...
        <script type="text/javascript" language="javascript">
             $(function () {  
                ...
                $.ajax({
                    url: "OrganisationTypeDesignationController",
                    dataType: "json",
        ...
        $("#searchgeneration").autocomplete({
            ...
            source: function (request, response) {
              var random = document.getElementById("searchhierarchy").value;
                $.ajax({
                    url: "OrganisationTypeDesignationController",
                    dataType: "json",
                    data: {action1: "gethierarchy",str:random},
                    success: function (data) {
          ...
          $("#designation").autocomplete({
            ...
            $("#p_designation").autocomplete({
                    
                source: function (request, response) {
                var code = document.getElementById("designation_code").value;
                var random = document.getElementById("p_designation").value;
                ...
                $.ajax({
                    url: "OrganisationTypeDesignationController",
                    dataType: "json",
                    data: {action1: "getParentDesignation",
                           action2: code,str:random,
                           action3 :editable,       
                           action4: generation,
                           action5:designation
            ...
            select: function (events, ui) {
                console.log(ui);
                $('#p_designation').val(ui.item.label); // display the selected text
                return false;
            }
        });  
          ...
          $("#searchDesignation").autocomplete({
            ...
            function makeEditable(id) {
                ...
                document.getElementById("designation").disabled = false;
                 document.getElementById("designation_code").disabled = false;
                   document.getElementById("p_designation").disabled = false;
                if(id == 'new') {
                    editable="false";
                    $("#message").html("");
            ...
            function fillColumns(id)
            {
                ...
                document.getElementById("designation").value = document.getElementById(t1id + (lowerLimit +2)).innerHTML;
                   document.getElementById("p_designation").value = document.getElementById(t1id + (lowerLimit +3)).innerHTML;
                document.getElementById("description").value = document.getElementById(t1id + (lowerLimit + 4)).innerHTML;
               
                 if(document.getElementById(t1id + (lowerLimit + 5)).innerHTML=='N')
                 {
                   document.getElementById("supern").checked = document.getElementById(t1id + (lowerLimit + 5)).innerHTML;
                    document.getElementById("supery").unchecked = document.getElementById(t1id + (lowerLimit + 5)).innerHTML;
               } 
               else
               {
                    document.getElementById("supery").checked = document.getElementById(t1id + (lowerLimit + 5)).innerHTML;
                      document.getElementById("supern").unchecked = document.getElementById(t1id + (lowerLimit + 5)).innerHTML;
               }
                   
                  document.getElementById("generation").value = document.getElementById(t1id + (lowerLimit + 6)).innerHTML;
            ...
            function setStatus(id) {debugger;
                if(id == 'save'){
                 ...
                 function searchDesignationList(id)
            {
                ...
                var action;
                if(id=='viewPdf')
                 action="requester=PRINT&searchgeneration="+searchgeneration+"&searchDesignationCode="+searchDesignationCode+"&active="+active+"&searchhierarchy="+searchhierarchy;
               else
                action="requester=generateDesignationXlsReport&searchDesignation="+searchDesignation+"&searchDesignationCode="+searchDesignationCode;
                var url="OrganisationTypeDesignationController?"+action;
    ...
    <body>
       <div class="container-fluid">
         ...
         <div class="container  topbox">
                                 <h1>Organisation Type Designation </h1>
                             </div>

                                                <div class="container">
                          
                                    <form name="form0" class="form-group row boxeffext" method="POST" action="OrganisationTypeDesignationController">
                                        <table  align="center"   width="600" class="table table-bordered table-striped">
                                            <tr>
                                                <th>Organisation Type</th>
                                                           ...
                                                           <th>Generation</th>
                                                            <td><input class="form-control" type="text" id="searchgeneration" name="searchgeneration" value="${searchgeneration}" size="150" ></td>
                                                           <th>Org Design Hierarchy</th>
                                                            <td><input class="form-control" type="text" id="searchhierarchy" name="searchhierarchy" value="${searchhierarchy}" size="150" ></td>  
                                            </tr>
                                            <tr>
...
<!--                  <td align="center"><input class="btn btn-success" type="submit"  name="task" id="active" value="ACTIVE RECORDS"></td>
             ...
             <td>  <select class="ui dropdown form-control" name="task" id="hiera" >
                                                            ...
                                                            <td><input type="submit" class="btn btn-primary" id="hiera" name="search_org" value="SEARCH RECORDS" onclick="setStatus(id)"></td>
                                                               ...
                                                               <DIV class="container">
                                    <form name="form1" method="POST" action="OrganisationTypeDesignationController" class="boxeffext">
                                            ...
                                            <table id="table1" width="600"  border="1"  align="center" class="table table-bordered table-striped">
                                                <tr>
                                                                ...
                                                                <th class="heading" >Designation</th>
                                                                  <th class="heading" >Parent Designation</th>
<!--                                                                <th class="heading">Serial number</th>-->
                                                            ...
                                                            <c:forEach var="media" items="${requestScope['organisationList']}" varStatus="loopCounter">
                                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                                    ...
                                                                    <td id="t1c${IDGenerator.uniqueID}" class="input" onclick="fillColumns(id)" >${media.designation}</td>
                                                                     <td id="t1c${IDGenerator.uniqueID}" class="input" onclick="fillColumns(id)" >${media.p_designation}</td>
                                                                    <td id="t1c${IDGenerator.uniqueID}" class="input" style="display:none" onclick="fillColumns(id)" >${media.serialnumber}</td>
                                                                    <td id="t1c${IDGenerator.uniqueID}" class="input" onclick="fillColumns(id)" >${media.superp}</td>
                                                                    <td id="t1c${IDGenerator.uniqueID}" class="input" onclick="fillColumns(id)" >${media.generation}</td>
                                                                </tr>
                                                </c:forEach>
                                                <tr>
                                    ...
                                    <div class="container">
                                        <form name="form2" method="POST" class="form-group row boxeffext" action="OrganisationTypeDesignationController" onsubmit="return verify()">
                                            <table id="table2"  class="table table-bordered table-striped" border="0"  align="center" width="600">
                                               ...
                                               <tr>
                                                    ...
                                                    <th class="heading1" >Organisation Type</th><td><input class="form-control" type="text" id="designation_code" name="designation_code" value="" size="45" disabled></td>
                                                </tr>
                                                <tr>
                                                 ...
                                                 <tr>
                                                    <th class="heading1" >Parent Designation</th>
                                                    <td>
                                                       
                                                        <input class="form-control" type="text" id="p_designation" name="p_designation" value=""  size="45" disabled>
                                                    </td>
                                                </tr>
...
<!--                                                    <td><input class="form-control" type="text" id="super" name="super" value="" size="45" disabled></td>-->
<!--                                           <td> 
                                                
                                                   
                                              Yes:   <input type="radio" class="form-control"  id="super" value="Y" name="super">
                                                  
                                              No:   <input type="radio" class="form-control"  id="super" value="N" name="super">
