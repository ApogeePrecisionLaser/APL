...
<html>
    ...
    <body>
        <DIV class="container">
            <form name="form1" method="POST" action="KeypersonController" class="boxeffext">
                <table id="table1" width="600"  border="1"  align="center" class="table table-bordered table-striped boxeffext">
                    ...
                    <c:forEach var="emer" items="${requestScope['emerList']}"  varStatus="loopCounter">
                        <tr>
                            ...
                            <td id="${loopCounter.count }2">${emer.name}</td>
                            <td id="${loopCounter.count }3">${emer.number}</td>
                            <td id="${loopCounter.count }4">${emer.k_name}</td>
                            <td id="${loopCounter.count }5">${emer.k_emer_name}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
