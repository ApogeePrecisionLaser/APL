    ...
    $("#searchDesignationCode").autocomplete({
            ...
            source: function (request, response) {
             var random = document.getElementById("searchDesignationCode").value;
                $.ajax({
                    url: "OrgOfficeHierarchyController",
                    dataType: "json",
                    data: {action1: "getSerialNo",str:random},
    ...
    <body>
       <div class="container-fluid">
         ...
         <div class="container  topbox">
                                 <h1>Org Office Hierarchy</h1>
                             </div>

                                                <div class="container">
                          
                                    <form name="form0" class="form-group row boxeffext" method="POST" action="OrgOfficeHierarchyController">
                                        <table  align="center"   width="600" class="table table-bordered table-striped">
                                            <tr>
                                                <th>Serial number</th>
                                                            ...
                                                            <th>org Office</th>
                                                            <td><input class="form-control" type="text" id="searchDesignation" name="searchDesignation" value="${searchDesignation}" size="150" ></td>
                                                            ...
                                                            <td>   <input class="btn btn-info" type="button" id="viewXls" name="viewXls" value="Excel" onclick="searchDesignationList(id);"/>
                                                               ...
                                                               <DIV class="container">
                                    <form name="form1" method="POST" action="OrgOfficeHierarchyController" class="boxeffext">
                                     
                                            <table id="table1" width="600"  border="1"  align="center" class="table table-bordered table-striped">
                                                <tr>
                                                                <th class="heading">S.No.</th>
                                                                <th class="heading" > Org Office</th>
                                                            ...
                                                            <c:forEach var="media" items="${requestScope['organisationList']}" varStatus="loopCounter">
                                                                <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                                    ...
                                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" >${media.officename}</td>
                                                                    <td id="t1c${IDGenerator.uniqueID}" class="input" onclick="fillColumns(id)" >${media.parentofficename}</td>
...
<!--                                    <div class="container">
                                        <form name="form2" method="POST" class="form-group row boxeffext" action="designationCont.do" onsubmit="return verify()">
                                            <table id="table2"  class="table table-bordered table-striped" border="0"  align="center" width="600">
                                               ...
                                               <tr>
                                                    ...
                                                    <th class="heading1" >Org Office</th><td><input class="form-control" type="text" id="designation_code" name="designation_code" value="" size="45" disabled></td>
                                                </tr>
                                                <tr>
                                                    <th class="heading1" >Parent Org Office</th>
                                                    <td>
