...
<script  type="text/javascript" src="time/bootstrap-datetimepicker.min.js"></script>
        ...
        <script type="text/javascript" language="javascript">
               $(function () {  
                ...
                $.ajax({
                    url: "OrganisationDesignationHierarchyController",
                    dataType: "json",
         ...
         $("#searchDesignation").autocomplete({
                ...
                source: function (request, response) {
                var desgn = document.getElementById("searchDesignationCode").value;
                var random = document.getElementById("searchDesignation").value;
                $.ajax({
                    url: "OrganisationDesignationHierarchyController",
                    dataType: "json",
                    data: {action1: "getDesignation",
                           action2: desgn,str:random},
                    success: function (data) {
    ...
    <body>
       <div class="container-fluid">
         ...
         <div class="container  topbox">
                                 <h1>Organisation Designation Hierarchy</h1>
                             </div>

                                                <div class="container">
                          
                                    <form name="form0" class="form-group row boxeffext" method="POST" action="OrganisationDesignationHierarchyController">
                                            ...
                                            <tr>
                                                <th>Serial number</th>
                                                            ...
                                                            <td>   <input class="btn btn-info" type="button" id="viewXls" name="viewXls" value="Excel" onclick="searchDesignationList(id);"/>
                                                               ...
                                                               <DIV class="container">
                                    <form name="form1" method="POST" action="OrganisationDesignationHierarchyController" class="boxeffext">
                                            ...
                                            <table id="table1" width="600"  border="1"  align="center" class="table table-bordered table-striped">
                                                <tr>
                                                                ...
                                                                <th class="heading" >Parent Organisation</th>
                                                            ...
                                                            <c:forEach var="media" items="${requestScope['organisationList']}" varStatus="loopCounter">
                                                               <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                                    ...
                                                                    <td id="t1c${IDGenerator.uniqueID}" class="input" onclick="fillColumns(id)" >${media.parentdesignationname}</td>
