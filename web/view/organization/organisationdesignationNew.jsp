...
<script  type="text/javascript" src="time/bootstrap-datetimepicker.min.js"></script>
        ...
        <script type="text/javascript" language="javascript">
             $(function () {  
                ...
                $.ajax({
                    url: "OrganisationDesignationNewController",
                    dataType: "json",
        ...
        $("#searchhierarchy").autocomplete({
            ...
            source: function (request, response) {
              var random = document.getElementById("searchhierarchy").value;
                $.ajax({
                    url: "OrganisationDesignationNewController",
                    dataType: "json",
                    data: {action1: "searchhierarchy",str:random},
                    success: function (data) {
          ...
          $("#searchDesignation").autocomplete({
             ...
             function searchDesignationList(id)
            {
                ...
                var url="OrganisationDesignationNewController?"+action;
       ...
       <div class="container-fluid">
         ...
         <div class="container  topbox">
                                 <h1>Organisation Designation </h1>
                                    ...
                                    <form name="form0" class="form-group row boxeffext" method="POST" action="OrganisationDesignationNewController">
...
<!--                  <td align="center"><input class="btn btn-success" type="submit"  name="task" id="active" value="ACTIVE RECORDS"></td>
             ...
             <td>  <select class="ui dropdown form-control" name="task" id="hiera" >
                                                            ...
                                                            <td><input type="submit" class="btn btn-primary" id="hiera" name="search_org" value="SEARCH RECORDS" onclick="setStatus(id)"></td>
                                                               ...
                                                               <DIV class="container">
                                    <form name="form1" method="POST" action="OrganisationDesignationNewController" class="boxeffext">
...
<!--                                                                <th class="heading">Serial number</th>-->
                                    ...
                                    <div class="container">
                                        <form name="form2" method="POST" class="form-group row boxeffext" action="OrganisationDesignationNewController" onsubmit="return verify()">
