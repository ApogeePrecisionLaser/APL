...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            $(function () {
                $("#searchOrganisation").autocomplete({

                    source: function (request, response) {

                        var random = document.getElementById("searchOrganisation").value;

                        $.ajax({
                            url: "orgDetailEntryCont.do",
                            dataType: "json",
                            data: {action1: "searchOrganisation", str: random},
                    ...
                    select: function (events, ui) {
                        console.log(ui);
                        $('#searchOrganisation').val(ui.item.label); // display the selected text
                        return false;
                    }
                ...
                $("#organisation").autocomplete({
                    ...
                    select: function (events, ui) {
                        console.log(ui);
                        $('#organisation').val(ui.item.label); // display the selected text
                        return false;
                    }
                ...
                $("#office_city").autocomplete({
                    ...
                    source: function (request, response) {
                        ...
                        var random = document.getElementById("office_city").value;

                        $.ajax({
                            url: "orgDetailEntryCont.do",
                            dataType: "json",
                            data: {action1: "City", str: random},
                            success: function (data) {
                    ...
                    select: function (events, ui) {
                        console.log(ui);
                        $('#office_city').val(ui.item.label); // display the selected text
                        return false;
                    }
                ...
                $("#org_sub_type").autocomplete({

                    source: function (request, response) {

                        var random = document.getElementById("org_sub_type").value;
                        var exp = document.getElementById("org_type_name").value;
                        $.ajax({
                            url: "orgDetailEntryCont.do",
                            dataType: "json",
                            data: {action1: "getOrgSubTypeName", str: random, action2: exp},
                            success: function (data) {
                    ...
                    select: function (events, ui) {
                        console.log(ui);
                        $('#org_sub_type').val(ui.item.label); // display the selected text
                        return false;
                    }
                ...
                $("#person_city").autocomplete({
                    ...
                    source: function (request, response) {
                        ...
                        var random = document.getElementById("person_city").value;
                    ...
                    select: function (events, ui) {
                        console.log(ui);
                        $('#person_city').val(ui.item.label); // display the selected text
                        return false;
                    }
                ...
                $("#designation").autocomplete({
                    ...
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "orgDetailEntryCont.do",
                            dataType: "json",
                            data: {action1: "Designation", str: random},
                            success: function (data) {
                ...
                //               var exp=document.getElementById("office_type").value;
                //                $.ajax({
                //                    url: "orgDetailEntryCont.do",
                //                    dataType: "json",
                //                    data: {action1: "getOfficeCode",str:random,action2:exp},
                //                    success: function (data) {
                //                      
                //                        console.log(data);
                //                        response(data.list);
            ...
            jQuery(function () {
                ...
                //new ajax call for organisation

                //end of jax call for organisation
            ...
            function getOfficeDetail() {
              ...
              var searchorg = $.trim($("#searchOrganisation").val());
                var organisation_id = $.trim($("#organisation_id").val());
                var org_office_id = $('#searchOrgOffice :selected').val();
                if (org_office_id != 0) {
                    var queryString = "ajaxRequest=getOfficeDetail&organisation_id=" + organisation_id + "&org_office_id=" + org_office_id+"&searchOrganisation="+searchorg;
                   //  popup('popUpDiv');
                    $.post("orgDetailEntryCont.do", queryString, function (response_data) {
                        debugger;
                         var items = [];  
                         var data = response_data.items;
                     alert(data);
                        $.each(response_data, function (key, value) {
                            items.push(value);
                        });
...
//                makeFieldDisabled();
            ...
            function checkPostReq() {
                ...
                var queryString = "task=Save&subTask=SaveAllRecord&" + serializedForm;
                $.post("orgDetailEntryCont.do", queryString,
            ...
            function saveOrgOffice()
            {
                debugger;
                //alert("check");
                //alert("org idd -"+$("#organisation").val());
                var serializedForm = $('#mainForm').serialize();
                //alert(serializedForm);
                var queryString = "task=Save&subTask=saveOrgOffice&" + serializedForm;
                                    ...
                                    <th  align="center" style="border-right: none" nowrap>
                                        <form name="searchForm" id="searchForm" action="orgDetailEntryCont.do" method="post" onsubmit="return verifySearch()">
                                            <table class="header_table" width="100%">
                                                <tr align="center">
                                                    <td>
                                                        <input class="btn btn-success" align="left" type="button" name="task" id="search" value="New Record" onclick="clearField();
                                                                clearFieldDisabled();
                                                                makeFieldButtonDisable()">
                                                    </td>
                                                    <td>                                                
                                                        ...
                                                        <input class="btn btn-info" type="button" id="saveUp" name="task" value="Save New Record" disabled onclick="checkPostReq()">
                                                    ...
                                                    <td>
                                                        <table id="table2" align="center"  border="1"  class="content" width="100%">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control" id="organisation" name="organisation" value="${orgDetail.organisation}" size="30" onkeyup="removeErrorField(id)">
                                                                </td>
                                                                <th class="heading1" >Organization Type</th>
                                                                <td>
                                                                    <input type="text" class="form-control" id="org_type_name" name="org_type_name" value="${orgDetail.org_type_name}" size="25">
                                                                </td>
                                                                <th class="heading1" >Org Sub Type</th>
                                                                <td>
                                                                    <input type="text" class="form-control" id="org_sub_type" name="org_sub_type" value="${orgDetail.org_sub_type}" size="25" >
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table width="100%">
                                                            <tr>
                                                                ...
                                                                <th align="center" width="40%">
                                                                    ...
                                                                    <input type="hidden" class="form-control" id="organisation" name="organisation" value="${orgDetail.organisation}" size="30" onkeyup="removeErrorField(id)">
                                                                </th>
                                                                <th width="30%" align="right" nowrap>
                                                                    ...
                                                                    <input type="button" class="btn btn-primary" name="orgOfNew" id="orgOfNew" value="New"  onclick="onOrgOfficeNew();">
                                                        ...
                                                        <table width="100%">
                                                            <tr>
                                                                ...
                                                                <th width="30%" align="right" nowrap>
                                                                    ...
                                                                    <input type="button" class="btn btn-primary" name="kpOfNew" id="kpNew" value="New" onclick="onPersonNew();">
