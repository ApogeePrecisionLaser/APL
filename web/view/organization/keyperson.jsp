...
<script>
    ...
    function fillColumn(id, count) {
        ...
        $('#city_name').val($("#" + count + '18').html());
        $('#emergency_name').val($("#" + count + '19').html());
        $('#emergency_number').val($("#" + count + '20').html());
        $('#id_type').val($("#" + count + '21').html());
        $('#id_no').val($("#" + count + '22').html());
    ...
    function verify() {
        ...
        if (document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New') {
            ...
            if (myLeftTrim(document.getElementById("employeeId").value).length == 0) {
                $("#message").html('<div class="col-md-12 text-center"><label style="color:red"><b>Employee Id is required...</b></label></div>');
                document.getElementById("employeeId").focus();
                return false; // code to stop from submitting the form2.
            }
            if (myLeftTrim(document.getElementById("salutation").value) == '---Select---') {
                $("#message").html('<div class="col-md-12 text-center"><label style="color:red"><b>Salutation is required...</b></label></div>');
                document.getElementById("salutation").focus();
                return false; // code to stop from submitting the form2.
            }

            if (myLeftTrim(document.getElementById("key_person_name").value).length == 0) {
                $("#message").html('<div class="col-md-12 text-center"><label style="color:red"><b>Key Person Name is required...</b></label></div>');
            ...
            if (myLeftTrim(document.getElementById("city_name").value).length == 0) {
            ...
            if (myLeftTrim(document.getElementById("address_line1").value).length == 0) {
                $("#message").html('<div class="col-md-12 text-center"><label style="color:red"><b>Address line1 is required...</b></label></div>');
                document.getElementById("address_line1").focus();
                return false; // code to stop from submitting the form2.
            }
            if (myLeftTrim(document.getElementById("mobile_no1").value).length == 0) {
                $("#message").html('<div class="col-md-12 text-center"><label style="color:red"><b>Mobile Number is required...</b></label></div>');
            ...
            if (myLeftTrim(document.getElementById("email_id1").value).length == 0) {
                $("#message").html('<div class="col-md-12 text-center"><label style="color:red"><b>Email ID is required...</b></label></div>');
                        ...
                        <tbody>                                     
                            <c:forEach var="key" items="${requestScope['keyList']}"  varStatus="loopCounter">
                                <tr  onclick="fillColumn('${key.key_person_id}', '${loopCounter.count }');">
                                    ...
                                    <td id="${loopCounter.count }16" >${key.address_line2}</td>
                                    <td id="${loopCounter.count }17" >${key.address_line3}</td>
                                    <td id="${loopCounter.count }18">${key.city_name}</td>
                                    <td id="${loopCounter.count }19">${key.emergency_name}</td>
                                    <td id="${loopCounter.count }20">${key.emergency_number}</td>
                                    <td id="${loopCounter.count }21">${key.id_type}</td>
                                    <td id="${loopCounter.count }22">${key.id_no}</td>
                                    ...
                                    <td id="${loopCounter.count }34" >
                                        <input type="btn normalBtn" class="btn btn-info" id="${loopCounter.count}" name="emp_code" value="Photo" onclick="viewDemandNote(${key.key_person_id}, 'ph')">
                                        <input type="btn normalBtn" style="margin-top:3px" class="btn btn-info" id="${loopCounter.count}" name="emp_code" value="ID" onclick="viewDemandNote(${key.key_person_id}, 'id')">
                                    </td>
                ...
                <div class="col-md-3">
                    <div class="">
                        <div class="form-group">
                            ...
                            <input class="form-control myInput" type="text" id="employeeId" name="employeeId" value="${counting}"  size="28" disabled>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
